...
const char* WalletDBInit[] =
{
    ...
    // Fetches are made to the CAS.  This gets the skywell.txt so even validators
    // without a web server can publish a skywell.txt.
    // Source:
    //  'M' = Manually added.   : 1500
    //  'V' = validators.txt    : 1000
    //  'W' = Web browsing.     :  200
    ...
    // Referral:
    //  This is the form provided by the skywell.txt:
    ...
    // List of referrals from skywell.txt files.
    // Validator:
