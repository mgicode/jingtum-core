...
int run (int argc, char** argv)
{
    ...
    if (vm.count ("version"))
    {
        std::cout << "skywelld version " << BuildInfo::getVersionString () << std::endl;
...
int main (int argc, char** argv)
{
    ...
    static_assert (gccver >= 40801, "GCC version 4.8.1 or later is required to compile skywelld.");
#endif

    static_assert (BOOST_VERSION >= 105700, "Boost version 1.57 or later is required to compile skywelld");
    ...
    auto const result (skywell::run (argc, argv));
