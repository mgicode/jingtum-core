...
The _Skywell payment network_ consists of a collection of _peers_ running
**skywelld**. Each peer maintains multiple outgoing connections and optional
...
fully connected directed graph of nodes where vertices are instances of skywelld
...
establishment, defines the _Skywell peer protocol_ (_protocol_ in this context).
...
* _User Defined_ (Unimplemented)
    ...
    The skywelld operator may specify additional, optional fields and values
