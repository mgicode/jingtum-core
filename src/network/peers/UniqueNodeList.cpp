...
public:
    ...
    // Queue a domain for a single attempt fetch a skywell.txt.
...
private:
    ...
    // Given a skywell.txt, process it.
    //
    ...
    // Try to process the next fetch of a skywell.txt.
    void fetchNext ()
    {
        bool    bFull;
    ...
    // Get the skywell.txt and process it.
    ...
    // After fetching a skywell.txt from a web site, given a IniFileSections with validators, parse and persist it.
