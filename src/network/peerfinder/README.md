...
The _Skywell payment network_ consists of a collection of _peers_ running the
**skywelld software**. Each peer maintains multiple outgoing connections and
...
**skywelld** is launched, the existing Bootcache database data is accessed and
...
outgoing connections to foreign peers. This security feature helps skywelld
