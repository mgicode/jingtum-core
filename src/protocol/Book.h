...
template <bool ByValue>
struct hash <skywell::IssueType <ByValue>>
    : private boost::base_from_member <std::hash <skywell::Currency>, 0>
    , private boost::base_from_member <std::hash <skywell::Account>, 1>
{
private:
    typedef boost::base_from_member <
        std::hash <skywell::Currency>, 0> currency_hash_type;
    typedef boost::base_from_member <
        std::hash <skywell::Account>, 1> issuer_hash_type;

public:
    typedef std::size_t value_type;
    typedef skywell::IssueType <ByValue> argument_type;
...
template <bool ByValue>
struct hash <skywell::BookType <ByValue>>
{
private:
    typedef std::hash <skywell::IssueType <ByValue>> hasher;

    hasher m_hasher;

public:
    typedef std::size_t value_type;
    typedef skywell::BookType <ByValue> argument_type;
...
template <bool ByValue>
struct hash <skywell::IssueType <ByValue>>
    : std::hash <skywell::IssueType <ByValue>>
{
    typedef std::hash <skywell::IssueType <ByValue>> Base;
...
template <bool ByValue>
struct hash <skywell::BookType <ByValue>>
    : std::hash <skywell::BookType <ByValue>>
{
    typedef std::hash <skywell::BookType <ByValue>> Base;
    //  NOTE broken in vs2012
    //using Base::Base; // inherit ctors
};
