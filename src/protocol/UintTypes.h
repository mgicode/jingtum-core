...
template <>
struct hash <skywell::Account> : skywell::Account::hasher
{
};

template <>
struct hash <skywell::Currency> : skywell::Currency::hasher
{
};

template <>
struct hash <skywell::NodeID> : skywell::NodeID::hasher
{
};

template <>
struct hash <skywell::Directory> : skywell::Directory::hasher
{
};
