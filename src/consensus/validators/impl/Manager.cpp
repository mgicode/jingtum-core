...
/** ChosenValidators (formerly known as UNL)
    ...
    In order that skywelld administrators may publish their ChosenValidators
    ...
    TODO:
      ...
      Template: https://skywell.com/wiki/Federation_protocol
      - What to do if you're a publisher of ValidatorList
      - What to do if you're a skywelld administrator
      - Overview of how ChosenValidators works

    Goals:
      Make default configuration of skywelld secure.
