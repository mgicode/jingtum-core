...
public:
    ...
    */
    ...
    // Deprecated.
    bool isZero () const { return *this == skywell::zero; }
    bool isNonZero () const { return *this != skywell::zero; }
    void zero () { *this = skywell::zero; }
};
...
template <std::size_t Bits, class Tag>
struct hash<skywell::base_uint<Bits, Tag>>
{
    using argument_type = skywell::base_uint<Bits, Tag>;

    std::size_t
    operator()(argument_type const& u) const
    {
        return skywell::hardened_hash<>{}(u);
    }
};
