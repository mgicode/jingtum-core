...
There are two ledgers that are the most important for a skywelld server to have:
...
A distributed agreement protocol. Skywell uses the consensus process to solve
...
the transaction increments the sequence number.  This is how skywell prevents
...
**index:** 256-bit hash of this SkywellState.
...
The Skywell server permits clients to subscribe to a continuous stream of
