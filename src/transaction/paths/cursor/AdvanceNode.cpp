...
TER PathCursor::advanceNode (STAmount const& amount, bool reverse) const
{
    ...
    PathCursor withMultiQuality {skywellCalc_, pathState_, multi, nodeIndex_};
        ...
        else
        {
            ...
            else
            {
                     ...
                     getParentCloseTimeNC ()))
                {
                    ...
                    skywellCalc_.permanentlyUnfundedOffers_.insert(
                        node().offerIndex_);
                    continue;
                }
                ...
                if (node().saTakerPays <= zero || node().saTakerGets <= zero)
                {
                    ...
                    else if (skywellCalc_.permanentlyUnfundedOffers_.find (index)
                             != skywellCalc_.permanentlyUnfundedOffers_.end ())
                    {
                ...
                auto itPast = skywellCalc_.mumSource_.find (accountIssue);
                bool bFoundPast = (itPast != skywellCalc_.mumSource_.end ());
                ...
                if (node().saOfferFunds <= zero)
                {
                    ...
                    if (bReverse && !bFoundReverse && !bFoundPast)
                    {
                        ...
                        // still do deletions.
                        // Mark offer for always deletion.
                        skywellCalc_.permanentlyUnfundedOffers_.insert (node().offerIndex_);
                    }
                    else
                    {
