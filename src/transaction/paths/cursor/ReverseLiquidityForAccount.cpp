...
;
    ...
    // page section: https://skywell.com/wiki/Transit_Fees#Implementation
        ...
        else
        {
                ...
                // Did not complete redeeming previous IOUs.
            {
                ...
                skywellLiquidity (
                    skywellCalc_,
                    QUALITY_ONE,
                    skywellTransferRate(ledger(), node().account_, saCurIssueAct.getCurrency()),
                    saPrvRedeemReq,
                    node().saRevIssue,
                    previousNode().saRevRedeem,
                    saCurIssueAct,
    ...
    else if (previousNodeIsAccount && !nextNodeIsAccount)
    {
            ...
            && node().saRevDeliver)                 // Need some issued.
        {
            ...
            skywellLiquidity (
                skywellCalc_,
                QUALITY_ONE,
                skywellTransferRate(ledger(), node().account_, saCurDeliverAct.getCurrency()),
                saPrvRedeemReq,
                node().saRevDeliver,
                previousNode().saRevRedeem,
                saCurDeliverAct,
